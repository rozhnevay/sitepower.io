<template>
  <div class="payments">
    ...
    <div class="row col-md-4 text-muted additional-info">
      ...
      <form style="padding-right: 10px">
        ...
        <div class="row">
          <div class="col-md-2" style="padding-top: 25px;float: right;">
            <h4>Итого к оплате: <span class="badge badge-warning">{{paySum}}</span> &#8381;</h4>
          </div>
          <div class="col-md-2">
    ...
    <!--</div>-->
    <!--<hr>-->
    <!--<div class="row col-md-4 method" :class="!enablePay ? 'disabled' : ''">-->
